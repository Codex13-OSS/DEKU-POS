...
function renderSplitModal() {
  ...
  overlay.innerHTML = `
    <div class="history-modal-content" style="background:white; padding:16px; border-radius:12px; max-width:500px; margin:auto;">
      <div class="history-modal-header" style="display:flex; justify-content:space-between; align-items:center;">
        <strong>Dividir cuenta</strong>
        <button type="button" class="ghost" onclick="closeSplitModal()">Cerrar</button>
      </div>
      <div style="margin-bottom:16px;">
        <strong style="font-size:16px;">Personas</strong>
